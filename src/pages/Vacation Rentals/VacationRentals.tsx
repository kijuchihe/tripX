...
import styles from './VacationRentals.module.css'; // Ensure this file exists with the relevant styles

const VacationRentals: React.FC = () => {
  ...
  return (
    ...
    <section className={styles.topSection}>
      <h1 className={styles.heading}> Explore Places To Rent</h1>
